Pod::Spec.new do |s|
    s.name             = 'Yodo1AdsMopub'
    s.version          = '3.0.2'
    s.summary          = 'Mopub sdk v5.5.0 聚合 更新到 v5.6.0'
    s.description      = <<-DESC
    ...
    s.source_files = "#{s.version}" + '/*.h',"#{s.version}" + '/Avid/MPViewabilityAdapterAvid.{h,m}',"#{s.version}" + '/Avid/*.h',"#{s.version}" + '/MOAT/*.{h,m}',"#{s.version}" + '/MOAT/MPUBMoatMobileAppKit.framework/Headers/*.h'
    s.public_header_files = "#{s.version}" + '/*.h',"#{s.version}" + '/Avid/*.h',"#{s.version}" + '/MOAT/*.h',"#{s.version}" + '/MOAT/MPUBMoatMobileAppKit.framework/Headers/*.h'
