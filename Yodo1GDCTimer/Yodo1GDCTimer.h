...
/**
 Yodo1GDCTimer is a thread-safe timer based on GCD. It has similar API with `NSTimer`.
 Yodo1GDCTimer object differ from NSTimer in a few ways:
 ...
 */
@interface Yodo1GDCTimer : NSObject
