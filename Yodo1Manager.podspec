Pod::Spec.new do |s|
    s.name             = 'Yodo1Manager'
    s.version          = '3.4.4'
    s.summary          = 'v3.4.4- 2019-09-18
                            1.更新Soomla v5.0.2 [重大结构变化]
                          '
    s.description      = <<-DESC
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'Yodo1Soomla','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_AppLovin' do |ss|
        ...
        ss.dependency 'SoomlaAppLovin','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_InMobi' do |ss|
        ...
        ss.dependency 'SoomlaInMobi','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    # end
     ...
     s.subspec 'Soomla_Facebook' do |ss|
        ...
        ss.dependency 'SoomlaFacebook','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Tapjoy' do |ss|
        ...
        ss.dependency 'SoomlaTapjoy','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_UnityAds' do |ss|
        ...
        ss.dependency 'SoomlaUnityAds','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Vungle' do |ss|
        ...
        ss.dependency 'SoomlaVungle','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_IronSource' do |ss|
        ...
        ss.dependency 'SoomlaIronSource','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_AdMob' do |ss|
        ...
        ss.dependency 'SoomlaAdMob','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_Chartboost' do |ss|
        ...
        ss.dependency 'SoomlaChartboost','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Toutiao' do |ss|
        ...
        ss.dependency 'SoomlaToutiao','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_Mintegral' do |ss|
        ...
        ss.dependency 'SoomlaMintegral','3.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
