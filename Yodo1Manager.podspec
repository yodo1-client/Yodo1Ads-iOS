Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'Yodo1Soomla','3.0.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_AppLovin' do |ss|
        ...
        ss.dependency 'SoomlaAppLovin','3.0.12'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_InMobi' do |ss|
        ...
        ss.dependency 'SoomlaInMobi','3.0.11'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    # end
     ...
     s.subspec 'Soomla_Facebook' do |ss|
        ...
        ss.dependency 'SoomlaFacebook','3.0.12'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Tapjoy' do |ss|
        ...
        ss.dependency 'SoomlaTapjoy','3.0.11'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_UnityAds' do |ss|
        ...
        ss.dependency 'SoomlaUnityAds','3.0.10'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Vungle' do |ss|
        ...
        ss.dependency 'SoomlaVungle','3.0.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_IronSource' do |ss|
        ...
        ss.dependency 'SoomlaIronSource','3.0.11'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_AdMob' do |ss|
        ...
        ss.dependency 'SoomlaAdMob','3.0.10'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_Chartboost' do |ss|
        ...
        ss.dependency 'SoomlaChartboost','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     ...
     s.subspec 'Soomla_Toutiao' do |ss|
        ...
        ss.dependency 'SoomlaToutiao','3.0.1'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Soomla_Mintegral' do |ss|
        ...
        ss.dependency 'SoomlaMintegral','3.0.1'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
