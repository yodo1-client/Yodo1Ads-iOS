Pod::Spec.new do |s|
    ...
    s.subspec 'Banner_Admob' do |ss|
        ...
        ss.dependency 'BannerAdmob','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Banner_Wmad' do |ss|
        ...
        ss.dependency 'BannerWmad','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'Banner_Inmobi' do |ss|
        ...
        ss.dependency 'BannerInmobi','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Banner_Applovin' do |ss|
        ...
        ss.dependency 'BannerApplovin','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Interstitial_Wmad' do |ss|
        ...
        ss.dependency 'InterstitialWmad','3.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
