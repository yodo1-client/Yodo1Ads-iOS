...
@interface Yodo1AntiIndulgedDialogVC ()
...
@implementation Yodo1AntiIndulgedDialogVC

+ (void)showDialog:(Yodo1AntiIndulgedDialogStyle)style error:(NSString * _Nullable)error {
    UIViewController *topVC = [Yodo1AntiIndulgedUtils getTopViewController];
    Yodo1AntiIndulgedDialogVC *vc = [Yodo1AntiIndulgedDialogVC loadFromStoryboard];
    vc.style = style;
    vc.msg = error;
...
- (void)viewDidLoad {
    ...
    switch (_style) {
        case Yodo1AntiIndulgedDialogStyleBuyOverstep: {
            // 超出购买额度
        ...
        case Yodo1AntiIndulgedDialogStyleTimeDisable: {
            // 禁玩时段
        ...
        case Yodo1AntiIndulgedDialogStyleTimeOverstep: { // 时间超出
            Yodo1AntiIndulgedRecord *record = [Yodo1AntiIndulgedTimeManager manager].record;
        ...
        case Yodo1AntiIndulgedDialogStyleBuyDisable: {
            // 禁止购买
            _iconView.image = [UIImage imageNamed:@"error"];
        ...
        case Yodo1AntiIndulgedDialogStyleVisitorOver: {
            // 游客模式结束
        ...
        case Yodo1AntiIndulgedDialogStyleNetError: {
            // 网络错误
        ...
        case Yodo1AntiIndulgedDialogStyleCheckDisable: {
            // 验证次数用完
        ...
        case Yodo1AntiIndulgedDialogStyleCheckUnable: {
            // 无法通过审核
            _iconView.image = [UIImage imageNamed:@"error"];
...
- (IBAction)onCkeckClicked:(id)sender {
    [Yodo1AntiIndulgedUtils showVerifyUI: YES];
}

// 退出游戏
- (IBAction)onQuitClicked:(id)sender {
    switch (_style) {
        case Yodo1AntiIndulgedDialogStyleTimeDisable: // 禁玩时段
        case Yodo1AntiIndulgedDialogStyleTimeOverstep: // 时间超出
        case Yodo1AntiIndulgedDialogStyleVisitorOver: // 游客模式结束
            // 退出游戏
            exit(0);
            break;
        default:
