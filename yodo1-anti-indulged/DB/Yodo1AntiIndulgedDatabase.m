...
@interface Yodo1AntiIndulgedDatabase()

@property (nonatomic, strong) FMDatabase *database;

@end

@implementation Yodo1AntiIndulgedDatabase

+ (Yodo1AntiIndulgedDatabase *)shared {
    static Yodo1AntiIndulgedDatabase *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[Yodo1AntiIndulgedDatabase alloc] init];
    });
...
- (instancetype)init {
    ...
    if (self) {
        ...
        NSString *path = [[[Yodo1Tool shared] documents] stringByAppendingFormat:@"/yodo1-anti-indulged-%@.db", appKey];
        ...
        if ([_database open]) {
            ...
            [statements appendFormat:@"%@\n", [Yodo1AntiIndulgedUser createSql]];
            [statements appendFormat:@"%@\n", [Yodo1AntiIndulgedRecord createSql]];
