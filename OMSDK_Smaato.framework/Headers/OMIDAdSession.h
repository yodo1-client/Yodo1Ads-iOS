 ...
 */
@property (nonatomic, readonly, nonnull) OMIDSmaatoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDSmaatoAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDSmaatoAdSessionContext *)context
 ...
 */
- (void)logErrorWithType:(OMIDErrorType)errorType message:(nonnull NSString *)message NS_SWIFT_NAME(logError(withType:message:));
