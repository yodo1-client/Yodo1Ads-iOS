 ...
 */
@interface OMIDOathAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDOathAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDOathAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDOathAdSessionContext *)context
