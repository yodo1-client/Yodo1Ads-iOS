 ...
 */
@interface OMIDOathAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDOathPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDOathPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDOathVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
