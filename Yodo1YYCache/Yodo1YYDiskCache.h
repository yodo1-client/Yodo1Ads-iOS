...
/**
 Yodo1YYDiskCache is a thread-safe cache that stores key-value pairs backed by SQLite
 and file system (similar to NSURLCache's disk cache).
 
 Yodo1YYDiskCache has these features:
 ...
 */
@interface Yodo1YYDiskCache : NSObject
