...
@implementation Yodo1AntiIndulgedHolidayRules
...
@implementation Yodo1AntiIndulgedRuleMsg
...
@implementation Yodo1AntiIndulgedRules
...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super init]) {
        ...
        _guestModeMsg = [decoder decodeObjectOfClass:[Yodo1AntiIndulgedRuleMsg class] forKey:@"guestModeMsg"];
        _playingTimeMsg = [decoder decodeObjectOfClass:[Yodo1AntiIndulgedRuleMsg class] forKey:@"playingTimeMsg"];
        _antiPlayingTimeMsg = [decoder decodeObjectOfClass:[Yodo1AntiIndulgedRuleMsg class] forKey:@"antiPlayingTimeMsg"];
