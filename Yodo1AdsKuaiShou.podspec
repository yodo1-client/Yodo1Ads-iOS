Pod::Spec.new do |s|
    ...
    s.resource = "#{s.version}" + '/KSAdSDK.framework/*.bundle'
    ...
    s.dependency 'LibSDWebImage','4.0.0'
    s.dependency 'LibAFNetworking','4.0.0'
    s.dependency 'LibGodzippa','4.0.0'
    s.dependency 'LibMJExtension','4.0.0'
