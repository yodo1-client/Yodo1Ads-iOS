...
NSString* const RMStoreCoderOrderIdKey = @"orderIdKey";
...
- (instancetype)initWithCoder:(NSCoder *)decoder
{
    if (self = [super init])
    {
        ...
        _orderId = [decoder decodeObjectForKey:RMStoreCoderOrderIdKey];
    }
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)coder
{
    ...
    if (self.orderId != nil) {
        [coder encodeObject:self.orderId forKey:RMStoreCoderOrderIdKey];
    }
}
